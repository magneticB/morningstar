...
SAMPLE_SPREADSHEET_ID = '1__TDv7v8b-GrvGXzurCeycj849ArR2OcDneFAMi1uVw'
SAMPLE_RANGE_NAME = 'Sheet1!E8:E'



class GSheetAdaptor:

    def login_and_get_gsheet(self):
        creds = None
    ...
    def test(self):
        sheet = self.login_and_get_gsheet()
        ...
        if not values:
            ...
            for row in values:
                ...
                ms_id = ms.get_morningstar_id_by_ticker(row[0])
                print('%s, %s' % (row[0], ms_id))
